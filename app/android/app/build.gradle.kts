...
tasks.named("preBuild") {
    dependsOn(syncGoogleServicesJson, syncServerAssets, syncSystemAssets, syncUserDefaults, verifyPythonRuntime, buildUsbLibs, fetchNodeRuntime, fetchTermuxTools, syncDependencyInventoryAsset)
}
