...
tasks.named("preBuild") {
    dependsOn(syncServerAssets, syncSystemAssets, syncUserDefaults, verifyPythonRuntime, buildUsbLibs, buildFacadeWheels, fetchOpenCvAndroidSdk, fetchNodeRuntime, syncDependencyInventoryAsset)
}
