...
object ToolDefinitions {
    ...
    val ACTIONS: Map<String, ActionSpec> = mapOf(
        ...
        "mcu.models" to ActionSpec("GET", "/mcu/models", false),
        "mcu.probe" to ActionSpec("POST", "/mcu/probe", true),
        "mcu.flash.plan" to ActionSpec("POST", "/mcu/flash/plan", false),
        "mcu.flash" to ActionSpec("POST", "/mcu/flash", true),
        "mcu.diag.serial" to ActionSpec("POST", "/mcu/diag/serial", true),
        "mcu.serial_lines" to ActionSpec("POST", "/mcu/serial_lines", true),
        "mcu.reset" to ActionSpec("POST", "/mcu/reset", true),
        "mcu.serial_monitor" to ActionSpec("POST", "/mcu/serial_monitor", true),
        "mcu.micropython.exec" to ActionSpec("POST", "/mcu/micropython/exec", true),
        "mcu.micropython.write_file" to ActionSpec("POST", "/mcu/micropython/write_file", true),
        "mcu.micropython.soft_reset" to ActionSpec("POST", "/mcu/micropython/soft_reset", true),
        "serial.exchange" to ActionSpec("POST", "/serial/exchange", true),
    ...
    val ACTION_TIMEOUTS: Map<String, Double> = mapOf(
        ...
        "mcu.probe" to 45.0,
        "mcu.flash.plan" to 30.0,
        "mcu.flash" to 900.0,
        "mcu.micropython.exec" to 120.0,
        "mcu.micropython.write_file" to 240.0,
        "mcu.micropython.soft_reset" to 30.0,
        "serial.exchange" to 30.0,
