...
class DeviceApiTool:
    _ACTIONS: Dict[str, Dict[str, Any]] = {
        ...
        "sensor.stream.status": {"method": "GET", "path": "/sensor/stream/status", "permission": True},
        "sensor.stream.latest": {"method": "GET", "path": "/sensor/stream/latest", "permission": True},
        "sensor.stream.batch": {"method": "GET", "path": "/sensor/stream/batch", "permission": True},
        ...
        "app.info": {"method": "GET", "path": "/app/info", "permission": False},
        "app.update.check": {"method": "GET", "path": "/app/update/check", "permission": False},
        "app.update.install": {"method": "POST", "path": "/app/update/install", "permission": True},
        ...
        "me.sync.progress": {"method": "GET", "path": "/me/sync/progress", "permission": False},
